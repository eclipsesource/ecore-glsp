 ...
 * @generated
 */
public class EnotationSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EnotationPackage.SEMANTIC_PROXY: {
