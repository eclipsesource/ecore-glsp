 ...
 * </p>
 * <ul>
 *   <li>{@link com.eclipsesource.glsp.ecore.enotation.impl.SemanticProxyImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link com.eclipsesource.glsp.ecore.enotation.impl.SemanticProxyImpl#getResolvedElement <em>Resolved Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticProxyImpl extends MinimalEObjectImpl.Container implements SemanticProxy {
	...
	protected EClass eStaticClass() {
		return EnotationPackage.Literals.SEMANTIC_PROXY;
	}
	...
	public void setUri(String newUri) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnotationPackage.SEMANTIC_PROXY__URI, oldUri, uri));
	}
	...
	public EObject getResolvedElement() {
		if (resolvedElement != null && resolvedElement.eIsProxy()) {
			...
			if (resolvedElement != oldResolvedElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EnotationPackage.SEMANTIC_PROXY__RESOLVED_ELEMENT, oldResolvedElement, resolvedElement));
			}
		}
	...
	public void setResolvedElement(EObject newResolvedElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EnotationPackage.SEMANTIC_PROXY__RESOLVED_ELEMENT, oldResolvedElement, resolvedElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EnotationPackage.SEMANTIC_PROXY__URI:
				return getUri();
			case EnotationPackage.SEMANTIC_PROXY__RESOLVED_ELEMENT:
