 ...
 * </p>
 * <ul>
 *   <li>{@link com.eclipsesource.glsp.ecore.enotation.impl.DiagramImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiagramImpl extends NotationElementImpl implements Diagram {
	...
	protected EClass eStaticClass() {
		return EnotationPackage.Literals.DIAGRAM;
	}
	...
	public EList<NotationElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<NotationElement>(NotationElement.class, this, EnotationPackage.DIAGRAM__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EnotationPackage.DIAGRAM__ELEMENTS:
